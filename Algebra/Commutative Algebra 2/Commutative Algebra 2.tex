...
Using the proposition it is easy to see that if $k$ is a field and $R=k[x_1,\dots,x_n]$ whose grading is given by $x_1,\dots,x_n$ being degree $1$, then we have $$HS_R(t)=\frac{1}{(1-t)^n}$$
