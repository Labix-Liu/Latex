...
\begin{prp}{}{} Let $(R,m)$ be a regular local ring. Then $m$ is generated by a regular sequence. 
\end{prp}
...
\begin{defn}{Cohen-Macauley Modules}{} Let $(R,m)$ be a Noetherian local ring. Let $M$ be a finitely generated $R$-module. We say that $M$ is Cohen-Macauley if $$\dim(R/\text{Ann}(M))=\text{depth}_m(M)$$
\end{defn}
