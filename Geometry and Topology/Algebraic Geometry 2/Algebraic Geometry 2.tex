...
\begin{defn}{Divisor of a Function}{} Let $X$ be an irreducible variety such that $\mO_{X,Y}$ is a regular local ring for all irreducible closed subvariety of $X$ of codimension $1$. Let $f\in K(X)$. Define the divisor of $f$ to be $$\text{div}(f)=\sum_{p\in X}v_p(f)\cdot p$$ where $v_p$ is the discrete valuation of the regular local ring $\mO_{X,p}$. 
\end{defn}
...
\begin{lmm}{}{} Let $X$ be an irreducible variety such that $\mO_{X,Y}$ is a regular local ring for all irreducible closed subvariety of $X$ of codimension $1$. Let $f\in K(X)$. Then we have $\text{div}(f)\in\text{Div}(X)$ is a divisor of $X$. 
\end{lmm}

\begin{defn}{Principal Divisors}{} Let $X$ be an irreducible variety such that $\mO_{X,Y}$ is a regular local ring for all irreducible closed subvariety of $X$ of codimension $1$. Define the subgroup of principal divisors of $X$ to be $$\text{Prin}(X)=\{\text{div}(f)\;|\;f\in K(X)\}\leq\text{Div}(X)$$
\end{defn}

\begin{defn}{Divisor Class Group}{} Let $X$ be an irreducible variety such that $\mO_{X,Y}$ is a regular local ring for all irreducible closed subvariety of $X$ of codimension $1$. Define the divisor class group of $X$ to be $$\text{Cl}(X)=\frac{\text{Div}(X)}{\text{Prin}(X)}$$ We say that two divisors $D$ and $D'$ of $X$ are linearly equivalent if $[D]=[D']\in\text{Cl}(X)$. 
\end{defn}
...
\begin{prp}{}{} Let $X$ be an irreducible variety such that $\mO_{X,Y}$ is a regular local ring for all irreducible closed subvariety of $X$ of codimension $1$. Then we have $$\ker(\deg)=\text{Prin}(D)$$ In particular, $D\in\text{Div}(X)$ is a principal divisor if and only if $\deg(D)=0$. 
\end{prp}
