...
\begin{defn}{Geodesics}{} Let $(X,d)$ be a metric space. Let $\gamma:I\to X$ be a function. We say that $\gamma$ is a geodesic if $$d(\gamma(a),\gamma(b))=\abs{b-a}$$ for all $a,b\in I$. 
\end{defn}
